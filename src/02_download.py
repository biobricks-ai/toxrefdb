...
api_endpoint = "https://clowder.edap-cluster.com/api/datasets/61147fefe4b0856fdc65639b/files"
...
download_path = os.path.join(download_dir, "mysql_toxrefdb.sql")
